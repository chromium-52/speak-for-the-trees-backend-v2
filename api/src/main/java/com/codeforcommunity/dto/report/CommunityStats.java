...
public class CommunityStats {
  ...
  public Integer getAdoptedCount() { return this.adoptedCount; }

  public Integer getTreesAdopted() { return this.treesAdopted; }

  public Integer getStewardshipActivities() { return this.stewardshipActivities; }
}
