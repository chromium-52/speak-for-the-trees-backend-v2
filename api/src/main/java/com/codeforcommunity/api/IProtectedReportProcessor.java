...
public interface IProtectedReportProcessor {
    ...
    /**
     * Returns a list of information about adopters and stewardship activities for each currently adopted site,
     * grouped by user and in alphabetical order, as a CSV-formatted string.
     */
    ...
    /**
     * Returns a list of information about adopters and the actions performed for each stewardship activity ever
     * performed, grouped by site_id and in reverse chronological order (most recent first), as a CSV-formatted string.
     */
    String getStewardshipReportCSV(JWTData userData, GetReportCSVRequest getStewardshipReportCSVRequest);
}
