...
public interface IReservationProcessor {
    ...
    /** Marks the given block as reserved for the given user/team by creating a new entry in the reservation table */
    void makeReservation(JWTData userData, MakeReservationRequest makeReservationRequest);

    /** Marks the given block as complete for the given user/team by creating a new entry in the reservation table */
    ...
    void uncompleteReservation(JWTData userData, UncompleteReservationRequest uncompleteReservationRequest);
